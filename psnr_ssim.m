...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%
file_path_X =  'C:\Users\Administrator\Desktop\gan\GCANet\gt\';% 参考图像文件夹路径
file_path_Y = 'C:\Users\Administrator\Desktop\gan\GCANet\dehazed\'; % 对比图像文件路径
 fid1=['C:\Users\Administrator\Desktop\gan\GCANet\','1.txt'];
    c=fopen(fid1,'w'); 
img_path_list_X = dir(strcat(file_path_X,'*.jpg'));%获取该文件夹中所有jpg格式的图像  
img_path_list_Y = dir(strcat(file_path_Y,'*.png'));%获取该文件夹中所有jpg格式的图像  
